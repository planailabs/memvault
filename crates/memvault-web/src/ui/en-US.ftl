...
graph-stat-nodes = Nodes
graph-stat-edges = Edges
graph-stat-kinds = Kinds
...
graph-section-incoming = Incoming · { $count }
graph-section-outgoing = Outgoing · { $count }
graph-legend-kinds = Kinds
graph-hint = drag · scroll · double-click to expand
